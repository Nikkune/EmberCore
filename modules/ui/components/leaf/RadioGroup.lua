...
local ____exports = {}
____exports.RadioGroup = __TS__Class()
local RadioGroup = ____exports.RadioGroup
RadioGroup.name = "RadioGroup"
function RadioGroup.prototype.____constructor(self, initialValue)
    self.listeners = __TS__New(Set)
    self.selectedValue = initialValue
end
function RadioGroup.prototype.isSelected(self, value)
    return self.selectedValue == value
end
function RadioGroup.prototype.select(self, value)
...
function RadioGroup.prototype.clear(self)
...
function RadioGroup.prototype.subscribe(self, listener)
    self.listeners:add(listener)
    return function()
        self.listeners:delete(listener)
    end
end
function RadioGroup.prototype.emit(self)
    for ____, listener in __TS__Iterator(self.listeners) do
        listener(nil, self.selectedValue)
    end
end
__TS__SetDescriptor(
