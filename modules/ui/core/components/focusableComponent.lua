...
local InteractiveComponent = ____ui.InteractiveComponent
...
local UIFocusableComponent = ____types.UIFocusableComponent
____exports.FocusableComponent = __TS__Class()
local FocusableComponent = ____exports.FocusableComponent
FocusableComponent.name = "FocusableComponent"
__TS__ClassExtends(FocusableComponent, InteractiveComponent)
function FocusableComponent.prototype.____constructor(self, kind, props, dependencies)
    if dependencies == nil then
        dependencies = {}
    end
    InteractiveComponent.prototype.____constructor(self, kind, props, dependencies)
    self._focused = false
end
function FocusableComponent.prototype.focus(self)
    if self._focused then
        return
    end
    self._focused = true
    self:invalidate({reason = "state", kind = "region", rect = self.rect})
end
function FocusableComponent.prototype.blur(self)
